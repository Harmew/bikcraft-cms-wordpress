...
<div class="quebra">
    <blockquote class="quote-externo container">
        <?php the_field("quote_externo", $contato); ?>
        <cite><?php the_field("quote_autor", $contato); ?></cite>
    </blockquote>
</div>
...
<footer>
    ...
    <div class="copy">
        <div class="container">
            <p class="grid-16"><?php bloginfo("name"); ?> <?php echo date(
   "Y"
